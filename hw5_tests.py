...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        q5 = hw5_cards.Deck()
        self.assertIsInstance(q5.deal_card(-1), hw5_cards.Card)
        return q5.deal_card(-1), hw5_cards.Card
    ...
    def test_q6(self):
        ...
        '''
        q6 = hw5_cards.Deck()
        cardlist = q6.cards.copy()
        numbe = len(q6.cards)
        q6.deal_card(-1)
        cardlist.pop(-1)
        numaf = len(q6.cards)
        self.assertEqual(q6.cards, cardlist)
        self.assertEqual(numaf, numbe-1)
        return numaf, numbe-1
    ...
    def test_q7(self):
        ...
        '''
        q7 = hw5_cards.Deck()
        cardlist = q7.cards.copy()
        num = len(cardlist)
        card = q7.deal_card(-1)
        numbe = len(q7.cards)
        q7.replace_card(card)
        numaf = len(q7.cards)
        self.assertEqual(q7.cards, cardlist)
        self.assertEqual(num, numaf, 52)
        return num, numaf, numbe+1
    ...
    def test_q8(self):
        ...
        '''
        q8 = hw5_cards.Deck()
        cardlist = q8.cards.copy()
        card = q8.deal_card(-1)
        q8.replace_card(card)
        numbe = len(q8.cards)
        q8.replace_card(card)
        numaf = len(q8.cards)
        self.assertEqual(q8.cards, cardlist)
        self.assertEqual(numaf, numbe)
        return numaf, numbe
